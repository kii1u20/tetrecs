...
public class GameWindow {
     ...
     */
    public void openScoreScreen(Game game) {
        Multimedia.stopPlayingBackgroundMusic();
        loadScene(new ScoreScene(this, game, game.isMultiplayer()));
    }
     ...
     */
    public void openMultiplayerGame(ObservableList<Node> userList) {
        Multimedia.stopPlayingBackgroundMusic();
        loadScene(new MultiplayerScene(this, userList));
    }
